                    ...
                    data.forEach(function (data, i) {
                        list = `
                            <tr>
                                ...
                                <td class="text-center">${ data['nama_mk'] } - ${ data['nama_kelas'] }</td>
                                <td class="text-center">${ data['jumlah_peserta_kelas'] }</td>
                                <td class="text-center">${ data['tgl_uts'] }</td>
                                <td class="text-center">${ data['batas_upload'] }</td>
                                <td class="text-center">${ data['tgl_pengisian_nilai'] }</td>
